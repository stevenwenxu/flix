...
Movie.create!([
  ...
  {title: "Captain Marvel", rating: "PG-13", total_gross: "1110662849.0", description: "Carol Danvers becomes one of the universe's most powerful heroes when Earth is caught in the middle of a galactic war between two alien races.", released_on: "2019-03-08", director: "Anna Boden", duration: "124 min", image_file_name: "captain-marvel.png", slug: "captain-marvel"},
  {title: "Black Panther", rating: "PG-13", total_gross: "1346913161.0", description: "T'Challa, heir to the hidden but advanced kingdom of Wakanda, must step forward to lead his people into a new future and must confront a challenger from his country's past.", released_on: "2018-02-16", director: "Ryan Coogler", duration: "134 min", image_file_name: "black-panther.png", slug: "black-panther"},
  {title: "Avengers: Infinity War", rating: "PG-13", total_gross: "2048359754.0", description: "The Avengers and their allies must be willing to sacrifice all in an attempt to defeat the powerful Thanos before his blitz of devastation and ruin puts an end to the universe.", released_on: "2018-04-27", director: "Anthony Russo", duration: "149 min", image_file_name: "avengers-infinity-war.png", slug: "avengers-infinity-war"},
  ...
  {title: "Fantastic Four", rating: "PG-13", total_gross: "168257860.0", description: "Four young outsiders teleport to an alternate and dangerous universe which alters their physical form in shocking ways. The four must learn to harness their new abilities and work together to save Earth from a former friend turned enemy.", released_on: "2015-08-07", director: "Josh Trank", duration: "100 min", image_file_name: "fantastic-four.png", slug: "fantastic-four"},
  {title: "Iron Man", rating: "PG-13", total_gross: "585366247.0", description: "When wealthy industrialist Tony Stark is forced to build an armored suit after a life-threatening incident, he ultimately decides to use its technology to fight against evil.", released_on: "2008-05-02", director: "Jon Favreau", duration: "126 min", image_file_name: "ironman.png", slug: "iron-man"},
  {title: "Superman", rating: "PG", total_gross: "300451603.0", description: "An alien orphan is sent from his dying planet to Earth, where he grows up to become his adoptive home's first and greatest super-hero.", released_on: "1978-12-15", director: "Richard Donner", duration: "143 min", image_file_name: "superman.png", slug: "superman"},
  ...
  {title: "Catwoman", rating: "PG-13", total_gross: "82102379.0", description: "Patience Philips seems destined to spend her life apologizing for taking up space. Despite her artistic ability she has a more than respectable career as a graphic designer.", released_on: "2004-07-23", director: "Jean-Christophe 'Pitof' Comar", duration: "101 min", image_file_name: "catwoman.png", slug: "catwoman"},
  ...
  {title: "Batman vs. Godzilla", rating: "PG-13", total_gross: "387623910.0", description: "An epic battle between The Caped Crusader and the fire-breathing dinosaur Gojira.", released_on: "2025-01-15", director: "", duration: "100", image_file_name: "placeholder.png", slug: "batman-vs-godzilla"}
])
